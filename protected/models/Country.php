...
/**
 * This is the model class for table "ld_country".
 *
 * The followings are the available columns in table 'ld_country':
...
class Country extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('country_id, iso2, short_name, long_name, iso3, numcode, un_member, calling_code, cctld', 'safe', 'on'=>'search'),
		);
	}
