	...
	$.fn.jNice = function(options){
		...
		this.each(function(){
			...
			$('input:checkbox', this).each(function(){
				$(this).addClass('jNiceHidden').wrap('<span class="jNiceCheck"></span>');
			...
			$('select', this).each(function(index){
				...
				$ul.hide().find('a').click(function(){
						...
						$ul.hide();
						$wrapper.removeClass('jNiceSelectWrapper2');
						return false;
				});
				/* Set the defalut */
			...
			$('a.jNiceSelectOpen', this).click(function(){
														var div = $(this).parent('div').parent();
														if(div.hasClass('jNiceSelectWrapper2')){
															div.removeClass('jNiceSelectWrapper2');
														}else{
															div.addClass('jNiceSelectWrapper2');
														}
